export const appwriteConfig = {
  ...
  studentCourseReg: process.env.NEXT_PUBLIC_APPRWRITE_ACADEMIN_SESSION_COLLECTION!,
  ...
  coursesCollectionId: process.env.NEXT_PUBLIC_APPRWRITE_COURSES_COLLECTION!,
